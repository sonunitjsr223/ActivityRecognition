...
%video = 'VIRAT_S_010005_04_000299_000323'; %c carrying object
%video = 'VIRAT_S_000201_02_000590_000623'; %c getting in car
%video = 'VIRAT_S_000201_03_000640_000672'; % getting out of car
...
disp(video);
 ...
 disp('Frames Extraction Completed...');
...
disp('Extracting Features for each frame...');
for i = 25:25:25*nframes
    disp('Computing features for frame: ');
    disp(i/25);
    %display(x);
